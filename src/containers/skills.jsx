            ...
            <div className='row mt-3'>
                <div className='col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6'>
                    <div class="container  mt-3">
                        ...
                        <div class="progress progress-striped10">
                    ...
                    <div class="container  mt-3">
                        ...
                        <div class="progress progress-striped11">
                            <div class="progress-bar11">
                            </div>                       
                        </div> 
                    </div>
                ...
                <div className='col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6'>
                    <div class="container  mt-3">
                        <div className='d-flex justify-content-between'>
                            <span className='text-white'>POWER POINT</span>
                            <span className='text-white'>90%</span>
                        </div>
                        <div class="progress progress-striped12">
                    ...
                    <div class="container  mt-3">
                        ...
                        <div class="progress progress-striped13">
                            <div class="progress-bar13">
                            </div>                       
                        </div> 
                    </div>
                </div>
